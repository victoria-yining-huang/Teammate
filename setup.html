      ...
      <div id="tabs" class="w3-container">
        ...
        <div id="tab-3" class="hidden">
          ...
          <div class="w3-container tab-content">
            ...
            <input type="file" id="conflict_data" />
            <button onclick="uploadConflicts()" class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Upload Conflicts</button>
            <br />
          ...
          <div class="w3-container w3-blue tab-footer page-footer">
            ...
            <button class="w3-button w3-black w3-xlarge w3-hover-white" onclick="generateTeams()">
              Generate Teams
            </button>
          </div>
        </div>
